...
109:goto 0;
110:ir := tir + tir; if n then goto 152;			{ 1111 1111 11 = HALT }
111:mar := sp; sp := sp + 1; rd;
112:rd;
113:a := mbr;										{ a is the top numbmer }
114:mar := sp; rd;
115:rd;
116:b := mbr; if z then goto 150;										{b is the bottom number}
117:c := (-1);
